...
import com.app.restaurantlogger.dataModel.toCuisine
...
interface SimplePlace {
    ...
    fun toPlace(uid: Int): Place = Place(
        uid = uid,
        name = name,
        address = address,
        cuisine = cuisine,
...
fun Place.toRestaurant(reviews: List<Review> = emptyList()): Restaurant = Restaurant(
    place = this,
    reviews = reviews,
)
